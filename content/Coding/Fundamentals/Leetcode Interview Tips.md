...
- there are gonna be two scenarios at this point
 1. i might know the optimized solution cause i already did same type of questions
 2. i don't know what to do and i need time to come up with the solution
...
- if choice 2
  ...
  1. state the flows with the brute force solution
  2. describe what you are thinking at each point
...
- test the edge cases as well
 	- empty arrays
 	- negative numbers
in the analysis step list the use cases not the time and space complexity
